...
from contig_test.contig_testImpl import contig_test


class contig_testTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('contig_test'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = contig_test(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_contig_test_" + str(suffix)
